...
export function classifyOpenChallengeError(code?: string): ApiErrorType {
  switch (code) {
    ...
    case 'CHALLENGE_REVIEW_ATTEMPT_NOT_COMPLETED':
    case 'CHALLENGE_REVIEW_ALREADY_RECOMMENDED':
    case 'CHALLENGE_REVIEW_RECOMMEND_NOT_FOUND':
    case 'CHALLENGE_REVIEW_NOT_RECOMMENDABLE':
    case 'CHALLENGE_FEEDBACK_ALREADY_EXISTS':
    case 'CHALLENGE_FEEDBACK_EMPTY':
    case 'CHALLENGE_FEEDBACK_ATTEMPT_NOT_COMPLETED':
    case 'CHALLENGE_FEEDBACK_ALREADY_SUBMITTED':
